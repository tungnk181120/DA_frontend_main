...
import './StudentTestContent.scss'
...
const rows = [
  ...
  createData(3, 13, 'Eclair', 'Đang làm bài', 6.0, 24, 'Chưa bắt đầu'),
  createData(4, 14, 'Cupcake', 'Đang làm bài', 3.7, 67, 'Chưa bắt đầu'),
  createData(5, 15, 'Gingerbread', 'Đang làm bài', 6.0, 49, 'Chưa bắt đầu'),
];
        ...
        <Table sx={{ minWidth: 1100, border:2, borderColor:'#f6f6f6'}} >
          <TableHead sx={{ bgcolor:'#f6f6f6',  }}>
            <TableRow>
              ...
              <TableCell sx={{ fontSize: 15, fontWeight:'bold'}} align="center">ID bài thi</TableCell>
              <TableCell sx={{ fontSize: 15, fontWeight:'bold'}} align="center">Lớp học</TableCell>
