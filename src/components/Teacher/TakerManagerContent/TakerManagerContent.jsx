...
import './TakerManagerContent.scss'
        ...
        <Table sx={{ minWidth: 1100, border:2, borderColor:'#f6f6f6'}} >
          <TableHead sx={{ bgcolor:'#f6f6f6',  }}>
            <TableRow>
              ...
              <TableCell sx={{ fontSize: 15, fontWeight:'bold'}} align="center">Mã kíp thi</TableCell>
          ...
          <TableBody>
            {rows.map((row) => (
              ...
              >
                <RouterLink to='/taker-manager/detail/:id'>
...
export default TakerManagerContent;